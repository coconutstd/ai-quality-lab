...
- [x] 22. 성능 계층 — 번들 게이트(hard) + Lighthouse 리포팅(soft) 두 레이어 조합. bundle-gate.mjs가 gzip 청크 크기 초과 시 CI fail. perf-report.mjs가 push:main 시 3페이지 Lighthouse 측정 후 artifact 저장. 코드 품질만 잡던 하네스에 사용자 체감 속도 신호 추가.
